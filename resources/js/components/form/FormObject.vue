    ...
    <b-form @submit="onSubmit" v-if="show">
        <input type="hidden" name="_token" v-bind:value="csrf">
                    ...
                    <b-form-group id="input-group-2" label="Entre el nombre:" label-for="input-2">
                     ...
                     <b-form-group id="input-group-3" label="Entre sus apellidos:" label-for="input-3">
                        <b-form-input
                        id="input-3"
                    ...
                    <b-form-group id="input-group-4" label="Entre su numero telefonico:" label-for="input-4">
                        <b-form-input
                        id="input-4"
                     ...
                     <b-form-group id="input-group-4" label="Entre la contraseña:" label-for="text-password">
                        <b-form-input type="password" id="text-password" aria-describedby="password-help-block"></b-form-input>
                    </b-form-group>

                    <b-form-group id="input-group-3" label="Entre el rol del usuario:" label-for="input-3">
                        <b-form-select
                        id="input-3"
                        v-model="form.role"
